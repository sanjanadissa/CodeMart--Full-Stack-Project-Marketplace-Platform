...
//           baseClasses,
//           widthStyle,
//           `[mask-image:linear-gradient(to_bottom,gray_33%,transparent_33%,transparent_66%,gray_66%)] [mask-size:1px_12px]`
//         );
//       case "line":
//       default:
...
//         darkMode ? "bg-black text-white" : "bg-gradient-to-br from-white/20 via-gray-100/20 to-indigo-100/20",
//         className
//       )}
//     >
...
//                   background: `linear-gradient(to bottom, #4500A5, #6A00A5, #620680)`,
...
//                     <motion.div
//                       className={cn(
//                         "w-6 h-6 rounded-full border-4 bg-[#1D1C1C] flex items-center justify-center",
//                         index <= activeIndex
//                           ? "border-white"
//                           : "border-black"
//                       )}
...
//                   >
//                     <Card className="bg-black border border-none">
...
//                           </div>
//                         ) : (
//                           <p className="text-lg font-bold text-[#A6A6A6] mb-2">
//                             {event.year}
//                           </p>
//                         )}
...
//                         </h3>
//                         {event.subtitle && (
//                           <p className="font-medium mb-2 text-[#A6A6A6]">
//                             {event.subtitle}
//                           </p>
//                         )}
...
export const ScrollTimeline = ({
  ...
  const getCardClasses = (index: number) => {
    ...
    const effectClasses = {
      none: "",
      glow: cn("gradient-card", index === activeIndex && "active-glow"),
      shadow: "hover:shadow-lg hover:-translate-y-1",
      bounce: "hover:scale-[1.03] hover:shadow-md active:scale-[0.97]",
    };
    const alignmentClassesDesktop =
  ...
  return (
    <div
      ref={scrollRef}
      className={cn(
        "relative min-h-screen w-full overflow-hidden pt-10",
        darkMode ? "bg-background text-foreground" : "bg-gradient-to-br from-white/20 via-gray-100/20 to-indigo-100/20",
        className
      )}
    >
      <div className="text-center py-16 px-4">
        <h1 className="about-title" style={{ position: "relative", top: "auto", left: "auto", transform: "none", marginBottom: "2rem" }}>{title}</h1>
